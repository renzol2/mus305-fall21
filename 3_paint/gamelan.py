...
if __name__ == '__main__':
    ...
    track0 = MidiFile.metatrack(
        ins={i: Vibraphone for i in range(microdivs)}, microdivs=microdivs)
    ...
    s10 = brush(score, pitch=melody, duration=8,
                rhythm=[2, 1, 1, .5, .5, 3, 1.5, 1.5, 4, 2,
                        1, 1, .5, .5, 3, 1.5, 1.5, 1.5, .5, 4],
    ...
    s12 = spray(score, pitch=60, duration=2, rhythm=.5,
                amplitude=A(.25), band=scale2, end=41)
